...
class PlacesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'address' => ['type' => 'string', 'length' => 128, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'time_open' => ['type' => 'time', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        'time_close' => ['type' => 'time', 'length' => null, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'places_address_uindex' => ['type' => 'unique', 'columns' => ['address'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'size' => 1,
                'active' => 1,
                'created' => '2018-05-13 21:53:06',
                'modified' => '2018-05-13 21:53:06',
                'time_open' => '21:53:06',
                'time_close' => '21:53:06'
            ],
        ];
