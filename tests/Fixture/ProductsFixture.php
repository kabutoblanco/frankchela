...
class ProductsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'products_product_types_id_fk' => ['type' => 'index', 'columns' => ['product_type_id'], 'length' => []],
            'products_product_categories_id_fk' => ['type' => 'index', 'columns' => ['product_category_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'products_name_uindex' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
            'products_product_categories_id_fk' => ['type' => 'foreign', 'columns' => ['product_category_id'], 'references' => ['product_categories', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
            'products_product_types_id_fk' => ['type' => 'foreign', 'columns' => ['product_type_id'], 'references' => ['product_types', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 1,
                'created' => '2018-05-16 01:15:25',
                'modified' => '2018-05-16 01:15:25'
            ],
        ];
        parent::init();
    }
