...
class EventTypesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'description' => ['type' => 'string', 'length' => 512, 'null' => false, 'default' => null, 'collate' => 'latin1_swedish_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        '_constraints' => [
            ...
            'event_types_name_uindex' => ['type' => 'unique', 'columns' => ['name'], 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'active' => 1,
                'created' => '2018-05-13 22:50:53',
                'modified' => '2018-05-13 22:50:53'
            ],
        ];
        parent::init();
    }
